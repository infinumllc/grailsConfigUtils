ruleset {
    ...
    EmptyMethod {
    	...
    	//DuplicateMapLiteral  -- This one is just used far to many places all over grails
    ...
    //DuplicateStringLiteral 
    	...
    	GrailsStatelessService {
			...
			addToIgnoreFieldNames = 'grailsApplication,messageSource,*Dao,*DataSource'
	    }
